const RULE_FIELDS = ['rule_name', 'source_folder_id', 'source_folder_name', 'target_folder_id', 'target_folder_name', 'target_sheet_id', 'target_sheet_name', 'sheet_tab_name', 'parsing_prompt', 'is_enabled'];
